...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className="hidden md:flex h-full w-28 bg-stone-950/80 backdrop-blur-xl border-r border-stone-800 flex-col items-center py-8 z-50">
      <div className="mb-10 w-14 h-14 bg-gradient-to-br from-stone-800 to-stone-900 rounded-2xl flex items-center justify-center shadow-lg border border-stone-800">
         <span className="font-black text-2xl text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-500">N</span>
      </div>
      ...
      <nav className="flex-1 flex flex-col w-full px-4 items-center overflow-y-auto no-scrollbar space-y-2">
        ...
        <div className="mt-auto pt-8 border-t border-stone-800 w-full flex flex-col items-center">
